...
function Highlights({ stats }) {
  return (
    ...
    <div className="bg-yellow-500 p-2 text-slate-200 flex flex-col justify-start items-center ">

     {/* SMALL HEADING LIKE WIND STATUS , HUMIDITY */}
      ...
      {stats.direction ? (
        <div className="flex mt-4">
            {/* ICON USED FROM HEROICONS.COM (SVG AND PATH IS COPIED FROM HEROICONS) */}
          <svg
