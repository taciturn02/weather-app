  ...
  return (
    <>
      <div className="flex align-middle justify-center">
        ...
        <input
          type="text"
          className="bg-yellow-500 border border-slate-500 text-slate-200 placeholder-slate-400 text-md focus:border-slate-400 block w-60 p-2 focus:outline-none"
